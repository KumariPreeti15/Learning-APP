...
export declare class OmniDropdown extends ElementInternalsBase<Option[]> {
    ...
    showxicon: boolean;
    options: Option[];
    /** the current value of the dropdown (pass an array with a single element for single-select and pass an arry with elements for multiselect */
    value: Option[];
    fetchOptionsFn: FetchOptionsFn;
    /** add an html template to the end of all dropdown options */
    optionsPostTemplate: (option: Option) => TemplateResult | unknown;
    /** adjust the character limit of the pill-list */
    pillListSliceAt: number;
    private targetEl;
    private labelEl;
     ...
     */
    enableOptions(options: Option[]): void;
