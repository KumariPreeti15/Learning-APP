...
declare const OmniTile_base: (new (...args: any[]) => {}) & typeof OmniElement;
/**
 * To include within your project `import { OmniTile } from 'omni-ui';`
 *
 * @tagname omni-tile
 ...
 */
export declare class OmniTile extends OmniTile_base {
    ...
    _hasHeader: boolean;
    /**@internal */
    _hasSubheader: boolean;
    /**@internal */
    _hasFooter: boolean;
    bodyScrollerDiv: HTMLDivElement;
    connectedCallback(): void;
    _onSlotChange(e: any): void;
...
export {};
//# sourceMappingURL=omni-tile.d.ts.map