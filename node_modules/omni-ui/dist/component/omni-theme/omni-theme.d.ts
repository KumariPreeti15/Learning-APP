import { OmniStyle } from '../omni-style/omni-style.js';
/**
 * To include within your project `import { OmniTheme } from 'omni-ui';`
 *
 ...
 * @tagname omni-theme
 */
export declare class OmniTheme extends OmniStyle {
    static get defaultSelector(): string;
    constructor();
    get selector(): string;
    set selector(cssSelector?: string);
    get styleSheet(): CSSStyleSheet;
    _formatRule([property, value]: [any, any]): string;
    _filterProperties([property]: [any]): any;
    _themeListener(event: any): void;
    connectedCallback(): void;
    disconnectedCallback(): void;
}
declare global {
    interface HTMLElementTagNameMap {
        'omni-theme': OmniTheme;
    }
}
//# sourceMappingURL=omni-theme.d.ts.map