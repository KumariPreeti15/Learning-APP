  ...
  #assistAvatarTemplate(size, cssClasses) {
    return html`
      <span class="omni-icon-image ${cssClasses}">
        <svg xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewbox="2 2 28 28">
          <g fill="currentColor" fill-rule="evenodd" transform="translate(-4 -4)">
            <circle cx="20" cy="20" r="5"></circle>
            <path
              fill-rule="nonzero"
              d="M9.5 12.3c.4.3.6 1 .3 1.4a12 12 0 0016.5 16.5 1 1 0 111 1.7A14 14 0 018.2 12.6a1 1 0 011.4-.3zm3.2-4.2a14 14 0 0119.2 19.3 1 1 0 01-1.7-1.1A12 12 0 0013.7 9.8a1 1 0 11-1-1.7z"></path>
          </g>
        </svg>
      </span>
    `;
...
__decorateClass([
  property({ type: Boolean })
], OmniAssistChatFullscreen.prototype, "showCopy", 2);
__decorateClass([
