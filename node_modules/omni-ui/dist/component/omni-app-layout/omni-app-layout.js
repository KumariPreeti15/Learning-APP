...
const _OmniAppLayout = class _OmniAppLayout extends OmniElement {
  constructor() {
    super(...arguments);
  ...
  connectedCallback() {
    ...
    window.removeEventListener("resize", _OmniAppLayout.computeViewportDims);
    window.addEventListener("resize", _OmniAppLayout.computeViewportDims);
  }
  ...
  firstUpdated() {
    ...
    _OmniAppLayout.computeViewportDims();
...
let OmniAppLayout = _OmniAppLayout;
