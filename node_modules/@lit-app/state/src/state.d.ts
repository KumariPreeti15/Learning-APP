...
export declare class State extends EventTarget {
    ...
    static initPropertyMap(): void;
    get propertyMap(): Map<PropertyKey, PropertyMapOptions>;
    get stateValue(): {
        [k: string]: unknown;
    };
    ...
    static createProperty(name: PropertyKey, options?: PropertyOptions): void;
    protected static getPropertyDescriptor(name: string, key: PropertyKey, options?: PropertyOptions): PropertyDescriptor;
    /**
