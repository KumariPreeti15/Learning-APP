...
if (DEV_MODE2) {
  LitElement["finalize"] = function() {
    const finalized3 = ReactiveElement.finalize.call(this);
    if (!finalized3) {
      return false;
    }
...
((_c2 = globalThis.litElementVersions) !== null && _c2 !== void 0 ? _c2 : globalThis.litElementVersions = []).push("3.3.3");
...
var supportsAdoptingStyleSheets2 = global3.ShadowRoot && (global3.ShadyCSS === void 0 || global3.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype;
...
var getCompatibleStyle2 = supportsAdoptingStyleSheets2 || NODE_MODE3 && global3.CSSStyleSheet === void 0 ? (s) => s : (s) => s instanceof CSSStyleSheet ? cssResultFromStyleSheet2(s) : s;
...
var DEV_MODE3 = true;
var requestUpdateThenable2;
var issueWarning3;
var trustedTypes2 = global4.trustedTypes;
var emptyStringForBooleanAttribute2 = trustedTypes2 ? trustedTypes2.emptyScript : "";
var polyfillSupport3 = DEV_MODE3 ? global4.reactiveElementPolyfillSupportDevMode : global4.reactiveElementPolyfillSupport;
if (DEV_MODE3) {
  const issuedWarnings = (_b3 = global4.litIssuedWarnings) !== null && _b3 !== void 0 ? _b3 : global4.litIssuedWarnings = /* @__PURE__ */ new Set();
  ...
  if (((_c3 = global4.ShadyDOM) === null || _c3 === void 0 ? void 0 : _c3.inUse) && polyfillSupport3 === void 0) {
  ...
  requestUpdateThenable2 = (name) => ({
    then: (onfulfilled, _onrejected) => {
      issueWarning3("request-update-promise", `The \`requestUpdate\` method should no longer return a Promise but does so on \`${name}\`. Use \`updateComplete\` instead.`);
      if (onfulfilled !== void 0) {
        onfulfilled(false);
      }
    }
...
var debugLogEvent2 = DEV_MODE3 ? (event) => {
...
var ReactiveElement2 = class extends HTMLElement {
   ...
   */
  static finalize() {
    if (this.hasOwnProperty(finalized2)) {
      return false;
    }
    ...
    if (DEV_MODE3) {
      const warnRemovedOrRenamed = (name, renamed = false) => {
        if (this.prototype.hasOwnProperty(name)) {
          issueWarning3(renamed ? "renamed-api" : "removed-api", `\`${name}\` is implemented on class ${this.name}. It has been ${renamed ? "renamed" : "removed"} in this version of LitElement.`);
        }
      };
      warnRemovedOrRenamed("initialize");
      warnRemovedOrRenamed("requestUpdateInternal");
  ...
  __propertyToAttribute(name, value, options = defaultPropertyDeclaration2) {
    var _a4;
    const attr = this.constructor.__attributeNameForProperty(name, options);
    if (attr !== void 0 && options.reflect === true) {
      const converter = ((_a4 = options.converter) === null || _a4 === void 0 ? void 0 : _a4.toAttribute) !== void 0 ? options.converter : defaultConverter2;
      const attrValue = converter.toAttribute(value, options.type);
      if (DEV_MODE3 && this.constructor.enabledWarnings.indexOf("migration") >= 0 && attrValue === void 0) {
  ...
  _$attributeToProperty(name, value) {
    ...
    if (propName !== void 0 && this.__reflectingProperty !== propName) {
      const options = ctor.getPropertyOptions(propName);
      const converter = typeof options.converter === "function" ? { fromAttribute: options.converter } : ((_a4 = options.converter) === null || _a4 === void 0 ? void 0 : _a4.fromAttribute) !== void 0 ? options.converter : defaultConverter2;
      this.__reflectingProperty = propName;
      this[propName] = converter.fromAttribute(
        value,
        options.type
  ...
  requestUpdate(name, oldValue, options) {
    ...
    return DEV_MODE3 ? requestUpdateThenable2(this.localName) : void 0;
  }
  /**
   * Sets up the element to asynchronously update.
   */
  ...
  _$didUpdate(changedProperties) {
    ...
    this.updated(changedProperties);
    if (DEV_MODE3 && this.isUpdatePending && this.constructor.enabledWarnings.indexOf("change-in-update") >= 0) {
...
polyfillSupport3 === null || polyfillSupport3 === void 0 ? void 0 : polyfillSupport3({ ReactiveElement: ReactiveElement2 });
if (DEV_MODE3) {
  ReactiveElement2.enabledWarnings = ["change-in-update"];
  const ensureOwnWarnings = function(ctor) {
...
((_d2 = global4.reactiveElementVersions) !== null && _d2 !== void 0 ? _d2 : global4.reactiveElementVersions = []).push("1.6.3");
if (DEV_MODE3 && global4.reactiveElementVersions.length > 1) {
...
lit-html/development/is-server.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-QO65DIIA.js.map
