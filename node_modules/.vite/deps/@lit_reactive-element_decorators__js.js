  ...
  return (obj, name) => {
    return desc(obj, name, {
      async get() {
        ...
        return ((_a2 = this.renderRoot) == null ? void 0 : _a2.querySelector(selector)) ?? null;
      }
    });
  };
}
...
function queryAssignedElements(options) {
  return (obj, name) => {
    ...
    return desc(obj, name, {
      get() {
        var _a2;
        const slotEl = (_a2 = this.renderRoot) == null ? void 0 : _a2.querySelector(slotSelector);
...
@lit/reactive-element/development/decorators.js:
  (**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   *)
*/
//# sourceMappingURL=@lit_reactive-element_decorators__js.js.map
